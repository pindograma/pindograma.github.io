/*
 * The original newsquiz.js is taken from
 * https://github.com/motherjones/newsquiz.  It is licensed under the MIT
 * License.
 *
 * The modifications to this file are (c) 2020 CincoNoveSeis Jornalismo Ltda.,
 * and are also licensed under the MIT License.
 */

(function($) {
    function score (nCorrect, nQuestions) {
        var answersWord = nCorrect === 1 ? 'pergunta' : 'perguntas';
        return 'Você acertou <span class="correct-answers">' + nCorrect + '</span> ' +
            ' de ' + nQuestions + ' ' + answersWord;
    }
    ...
    $.quiz = function(quiz_data, options) {
        ...
        var quiz = {
            ...
            build_possible_answer_elements_from_row : function(question, question_index) {
                var answers_container = $('<ul class="mb-5 list-unstyled possible_answers possible_answers_' +
                    question_index + '"></ul>');
                ...
                for (var i = 0; i < question.possible_answers.length; i++) {
                    ...
                    var possible_answer = $('<li class="my-2 quiz-item"><p class="my-0 possible_answer answer_' + i + '">' +
                        answer_data.answer +
                    '</p></li>');
            ...
            create_cover : function() {
                ...
                container_elem.addClass('list-unstyled');
        ...
        return quiz.init(quiz_data['quiz'], quiz_data['results'], options);
    };
