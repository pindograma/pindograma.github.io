...
author: daniel
image_url: /assets/post_images/ranking.png
date: 2020-09-07
---

<p>Pesquisas eleitorais são uma parte importante de toda eleição. Além de refletirem as intenções de voto no momento em que foram realizadas, elas pautam narrativas de candidatos e da mídia sobre a eleição – narrativas que, por sua vez, podem ter um impacto forte sobre a opinião pública.</p>
...
<p>Foi para responder essa pergunta que o <em>Pindograma</em> criou o seu Ranking de Institutos de Pesquisa. Nossa metodologia, inspirada nos critérios usados pelo site americano <a href="https://fivethirtyeight.com/features/how-fivethirtyeight-calculates-pollster-ratings/">FiveThirtyEight</a>, usa vários medidas para avaliar o desempenho passado dos institutos de forma objetiva.</p>
...
<p>Alguns meios de comunicação publicam pesquisas sem número; e outros publicam esse número de forma pouco ortodoxa. Mas quase sempre, pesquisas que foram divulgadas na Internet são localizáveis através de uma busca seu número em um <em>search engine</em>.</p>
<p>O <em>Pindograma</em> usou a <a href="https://azure.microsoft.com/en-us/services/cognitive-services/bing-web-search-api/">API do Bing</a> (o Google não tem API de busca) para automatizar a busca pelas 20.771 pesquisas registradas no TSE entre 2012 e 2018. Em seguida, veio a etapa mais trabalhosa do processo todo: <strong>transcrever os resultados</strong>. Toda a equipe do <em>Pindograma</em>, aliada por sete colaboradores, “preencheu planilhas” durante três meses para consolidar o levantamento mais completo de pesquisas para o período 2012-2018.</p>
<p>Desse processo, saíram 3.367 pesquisas eleitorais – o que pode parecer pouco, comparado com as 20 mil pesquisas registradas junto ao TSE. Mas diferença faz sentido, e se deve a alguns fatores:</p>
<ul>
...
<li><p>Acima de tudo, <strong>boa parte das pesquisas registradas para divulgação no Brasil simplesmente não é publicada</strong>. São sondagens que se encaixam em vários cenários: podem ter sido contratadas por candidatos a quem não interessava a publicação do resultado; podem ter sido encomendadas, mas canceladas por falta de pagamento; ou podem até mesmo ter sido registradas para <a href="realidade">burlar o controle da Justiça Eleitoral sobre pesquisas fraudulentas</a>, como já mostrou o <em>Pindograma</em>. O ponto é: institutos não têm nada a perder registrando pesquisas em excesso no sistema do TSE.</p></li>
</ul>
<p>De toda forma, o <em>Pindograma</em> pretende continuar alimentando sua base com pesquisas que for encontrando. <strong>E você pode nos ajudar com isso!</strong> Caso você saiba de uma pesquisa que não está aparecendo nosso banco de dados, mande um email para <a href="mailto:pesquisas@pindograma.com.br" class="email">pesquisas@pindograma.com.br</a>.</p>
</div>
...
<p>Pois bem: entre 2012 e 2018, o Poder360 acumulou 2.854 pesquisas “utilizáveis” – isto é, pesquisas que restaram após o tratamento dos dados e a remoção de sondagens que não tinham um número do TSE. E destas, <code>r pn(number_of_unique_p3_polls)</code> não foram localizadas no levantamento do <em>Pindograma</em>.</p>
...
#bykvrexzno .gt_bottom_border {
  border-bottom-style: #ffffff;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#bykvrexzno .gt_col_headings {
  border-top-style: solid;
...
#bykvrexzno .gt_column_spanner_outer {
  color: #FFFFFF;
  background-color: #d27103;
  font-size: 100%;
  font-weight: normal;
...
#bykvrexzno .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#bykvrexzno .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#bykvrexzno .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #ffffff;
  vertical-align: bottom;
...
#bykvrexzno .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#bykvrexzno .gt_from_md > :first-child {
  margin-top: 0;
}

#bykvrexzno .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#bykvrexzno .gt_first_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#bykvrexzno .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#bykvrexzno .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#bykvrexzno .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#bykvrexzno .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #ffffff;
  border-bottom-style: solid;
...
#bykvrexzno .gt_footnote {
  margin: 0px;
  font-size: 90%;
  padding: 4px;
}

#bykvrexzno .gt_sourcenotes {
  color: #333333;
  background-color: #FFFFFF;
  border-bottom-style: none;
  border-bottom-width: 2px;
...
#bykvrexzno .gt_font_normal {
  font-weight: normal;
}

#bykvrexzno .gt_font_bold {
  font-weight: bold;
}

#bykvrexzno .gt_font_italic {
  font-style: italic;
}
...
#bykvrexzno .gt_footnote_marks {
  font-style: italic;
  font-size: 65%;
}
</style>
<div id="bykvrexzno" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;"><table class="gt_table">
...
<p>Antes de descrever o cálculo do ranking dos institutos de pesquisa, é importante entender que toda pesquisa eleitoral erra ao compararmos seus percentuais com o resultado das eleições. Afinal, o eleitor sempre pode mudar de ideia entre o dia da pesquisa e a hora de digitar o voto. Também existe a chance de uma pesquisa ter caído, por puro azar, fora do intervalo de confiança.</p>
...
<h5>1) Seleção</h5>
<p>Para calcular o desempenho de cada instituto, o <em>Pindograma</em> não usou todas as pesquisas disponíveis na base. Ao invés disso, selecionamos as sondagens que entram no cálculo a partir dos seguintes critérios:</p>
<ul>
<li><p><strong>Pleitos majoritários</strong>. Foram excluídas pesquisas para deputado estadual, deputado federal, e senador.</p></li>
<li><p><strong>Âmbito da pesquisa</strong>. O <em>Pindograma</em> incluiu na análise as nacionais para presidente; estaduais para presidente; estaduais para governador; e municipais para prefeito. Não incluímos pesquisas para presidente ou governador no âmbito municipal. Também excluímos pesquisas cujo âmbito é uma região específica, como pesquisas para governador em cidades do litoral de São Paulo. (O âmbito de cada pesquisa é manualmente determinado pelo <em>Pindograma</em> através de dados do TSE).</p></li>
...
<p>Selecionadas as pesquisas, o <em>Pindograma</em> comparou seus resultados com o veredicto das urnas.</p>
...
#ycfgotmmpo .gt_bottom_border {
  border-bottom-style: #ffffff;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#ycfgotmmpo .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #ffffff;
  border-bottom-style: solid;
...
#ycfgotmmpo .gt_column_spanner_outer {
  color: #FFFFFF;
  background-color: #d27103;
  font-size: 100%;
  font-weight: normal;
...
#ycfgotmmpo .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#ycfgotmmpo .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#ycfgotmmpo .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #ffffff;
  vertical-align: bottom;
...
#ycfgotmmpo .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#ycfgotmmpo .gt_from_md > :first-child {
  margin-top: 0;
}

#ycfgotmmpo .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#ycfgotmmpo .gt_first_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#ycfgotmmpo .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#ycfgotmmpo .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#ycfgotmmpo .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#ycfgotmmpo .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #ffffff;
  border-bottom-style: solid;
...
#ycfgotmmpo .gt_footnote {
  margin: 0px;
  font-size: 90%;
  padding: 4px;
}

#ycfgotmmpo .gt_sourcenotes {
  color: #333333;
  background-color: #FFFFFF;
  border-bottom-style: none;
  border-bottom-width: 2px;
...
#ycfgotmmpo .gt_font_normal {
  font-weight: normal;
}

#ycfgotmmpo .gt_font_bold {
  font-weight: bold;
}

#ycfgotmmpo .gt_font_italic {
  font-style: italic;
}
...
#ycfgotmmpo .gt_footnote_marks {
  font-style: italic;
  font-size: 65%;
}
</style>
<div id="ycfgotmmpo" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;"><table class="gt_table">
  <thead class="gt_header">
    <tr>
...
<p>Esse exemplo foi escolhido de propósito, porque revela as limitações desse método para calcular o erro médio das pesquisas. O instituto pode cometer um erro crasso no que tange a alguns candidatos, mas esse erro acaba sendo diluído pelos “acertos” no que tange aos outros.</p>
...
#vorrmobcwb .gt_bottom_border {
  border-bottom-style: #ffffff;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#vorrmobcwb .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #ffffff;
  border-bottom-style: solid;
...
#vorrmobcwb .gt_column_spanner_outer {
  color: #FFFFFF;
  background-color: #d27103;
  font-size: 100%;
  font-weight: normal;
...
#vorrmobcwb .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#vorrmobcwb .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#vorrmobcwb .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #ffffff;
  vertical-align: bottom;
...
#vorrmobcwb .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#vorrmobcwb .gt_from_md > :first-child {
  margin-top: 0;
}

#vorrmobcwb .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#vorrmobcwb .gt_first_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#vorrmobcwb .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#vorrmobcwb .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#vorrmobcwb .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#vorrmobcwb .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #ffffff;
  border-bottom-style: solid;
...
#vorrmobcwb .gt_footnote {
  margin: 0px;
  font-size: 90%;
  padding: 4px;
}

#vorrmobcwb .gt_sourcenotes {
  color: #333333;
  background-color: #FFFFFF;
  border-bottom-style: none;
  border-bottom-width: 2px;
...
#vorrmobcwb .gt_font_normal {
  font-weight: normal;
}

#vorrmobcwb .gt_font_bold {
  font-weight: bold;
}

#vorrmobcwb .gt_font_italic {
  font-style: italic;
}
...
#vorrmobcwb .gt_footnote_marks {
  font-style: italic;
  font-size: 65%;
}
</style>
<div id="vorrmobcwb" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;"><table class="gt_table">
  <thead class="gt_header">
    <tr>
...
<li><p>Quantos dias faltam para a eleição;</p></li>
...
#mhuizimeqn .gt_bottom_border {
  border-bottom-style: #ffffff;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#mhuizimeqn .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #ffffff;
  border-bottom-style: solid;
...
#mhuizimeqn .gt_column_spanner_outer {
  color: #FFFFFF;
  background-color: #d27103;
  font-size: 100%;
  font-weight: normal;
...
#mhuizimeqn .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#mhuizimeqn .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#mhuizimeqn .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #ffffff;
  vertical-align: bottom;
...
#mhuizimeqn .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#mhuizimeqn .gt_from_md > :first-child {
  margin-top: 0;
}

#mhuizimeqn .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#mhuizimeqn .gt_first_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#mhuizimeqn .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#mhuizimeqn .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#mhuizimeqn .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#mhuizimeqn .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #ffffff;
  border-bottom-style: solid;
...
#mhuizimeqn .gt_footnote {
  margin: 0px;
  font-size: 90%;
  padding: 4px;
}

#mhuizimeqn .gt_sourcenotes {
  color: #333333;
  background-color: #FFFFFF;
  border-bottom-style: none;
  border-bottom-width: 2px;
...
#mhuizimeqn .gt_font_normal {
  font-weight: normal;
}

#mhuizimeqn .gt_font_bold {
  font-weight: bold;
}

#mhuizimeqn .gt_font_italic {
  font-style: italic;
}
...
#mhuizimeqn .gt_footnote_marks {
  font-style: italic;
  font-size: 65%;
}
</style>
<div id="mhuizimeqn" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;"><table class="gt_table">
...
<p>Caso a hipótese (1) seja verdadeira, o <em>Pindograma</em> ficaria mais do que feliz em ver outras pessoas fazendo rankings melhores. E caso a hipótese (2) estiver certa, bastaria esperar até o fim de 2020 – e talvez incluir pesquisas de 2010 na base – para comprovar o que já esperamos sobre o comportamento dos institutos. Entretanto, a hipótese (3) traz prospectos mais inquietantes: é possível que técnicas de pesquisa que funcionavam no passado não funcionem tão bem nos dias de hoje; ou que fazer boas pesquisas eleitorais seja mais uma questão de sorte do que de competência.</p>
<p>Ao nosso ver, ter levantado essas perguntas já é, por si só, um mérito do Ranking de Institutos. Mas não é só. Com o Ranking, é possível demonstrar a desigualdade no acesso a pesquisas eleitorais de qualidade pelo Brasil; elencar institutos que poderiam ser investigados por publicarem pesquisas de má qualidade; exigir uma prestação de contas das empresas de pesquisa; e sobretudo, qualificar o debate sobre pesquisas eleitorais no Brasil.</p>
<p>O <em>Pindograma</em> espera publicar várias reportagens em torno desses temas; mas também espera empoderar nossos leitores a responderem suas próprias perguntas sobre as pesquisas de opinião. Por isso, convidamos você a conferir os <a href="https://github.com/pindograma/pesquisas">dados e o código</a> por trás do Ranking – ambos integralmente abertos para a comunidade. Aproveite para deixar um comentário ou uma contribuição.</p>
<hr />
...
<p>Para reproduzir os números citados, o código pode ser consultado <a href="Rmd">aqui</a>.</p>
</div>
